...
import com.api.votos.ntconsult.repositorio.VotoRepositorio;
import com.api.votos.ntconsult.servico.*;
...
public class VotoServicoImpl implements VotoServico {
    ...
    public ResponseDTO votar(VotoRequestDTO votoRequestDTO) {
        ...
        ResponseDTO responseDTO = validarDadosVoto(retorno, votoRequestDTO);
     ...
     * */
    public ResponseDTO validarDadosVoto(ResponseDTO retorno, VotoRequestDTO votoRequestDTO) {
